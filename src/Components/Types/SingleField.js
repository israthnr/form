...
var InputTypes = [ 'Checkbox', 'Color', 'Date', 'Email', 'File',
    'Month', 'Number', 'Password', 'Radio', 'Range', 'Tel', 'Text', 'Time', 'Url', 'Week', 'Textarea'];
        ...
        return(
            <div className="card card-outline-primary">
                <div className="card-header">
                    <i className="text text-light fa fa-wpforms mr-1"> Single Field { this.state.title }</i>
                        ...
                        <div className="card-body">
                          ...
                          {/* 
                            ...
                            */}
                            ...
                            {(this.state.type==="Text" || this.state.type==="Range")  && 
