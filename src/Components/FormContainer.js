            ...
            <div className='toolbox' ref={(c) => this._toolBoxContainer = c}>
                ...
                <div className="card card-default" style={this.ifDuplicated()}>
                    <div className="card-header">
                        <span className="text text-light pull-left">Form Items</span>
                        <div className="actions pull-right">
                            <button data-toggle="modal" data-target="#previewModal" className="btn btn-sm btn-danger"
                            onClick={() => this.prevForm()} >Preview</button>
                            { ' ' }
                            { 
                                this.props.loader ? 
